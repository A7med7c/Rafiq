...
// Read en.ts and insert before "export const en = {"
let enTs = fs.readFileSync('RafiqMobile/src/app/i18n/en.ts', 'utf8');
enTs = enTs.replace('export const en = {', 'export const en = {\n' + enContent);
fs.writeFileSync('RafiqMobile/src/app/i18n/en.ts', enTs);

// Read ar.ts
let arTs = fs.readFileSync('RafiqMobile/src/app/i18n/ar.ts', 'utf8');
arTs = arTs.replace('export const ar = {', 'export const ar = {\n' + arContent);
