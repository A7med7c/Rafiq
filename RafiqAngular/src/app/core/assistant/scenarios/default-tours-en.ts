...
export const WELCOME_TOUR_EN: TourScenario = {
  ...
  steps: [
    ...
    {
      id: 'welcome-recent-records-en',
      anchor: 'recent-records-card',
      route: '/dashboard',
      speech: "Here is the 'Recent Medical Records' section on your dashboard, showing your latest lab tests, imaging, and prescriptions along with their status.",
      speechLanguage: 'en-US',
      avatarState: 'thinking',
      highlight: true,
    },
    {
      id: 'welcome-medications-reminders-en',
      anchor: 'medications-reminders-card',
      route: '/dashboard',
      speech: "And here is the 'Medications & Reminders' section to track active medicines and upcoming reminder times for each dose.",
      speechLanguage: 'en-US',
      avatarState: 'pointLeft',
      highlight: true,
    },
    {
      id: 'welcome-today-schedule-en',
      anchor: 'today-schedule-card',
      route: '/dashboard',
      speech: "Finally, 'Today's Schedule' shows all appointments and medication reminders scheduled for today in chronological order.",
      speechLanguage: 'en-US',
      avatarState: 'celebrate',
      highlight: true,
    },
