...
export const WELCOME_TOUR: TourScenario = {
  ...
  steps: [
    ...
    // 4 ── AI Health Summary
    {
      ...
      route: '/dashboard',
      speech: 'هُنا تَجِد \'المُلَخَّص الصِّحِّي الذَّكِي\'. أَقُوم بِتَحْلِيل بَياناتِكَ الطِّبِّيَّة بِاسْتِمْرار وأُزَوِّدُكَ بِإِرْشادات مُخَصَّصَة لِحالَتِكَ. يُمْكِنُكَ الضَّغْط عَلَى \'Open AI Assistant\' لِلتَّحَدُّث مَعِي عَن أَي تَفْصِيلَة فِيه.',
      speechLanguage: 'ar-EG',
      avatarState: 'thinking',
      highlight: true,
    },
    ...
    // 6 ── Upcoming appointment card (state-aware)
    {
      ...
      variants: {
        ...
        empty: {
          ...
          speech: 'فِي بِطاقَة \'Upcoming Appointment\' سَتَجِد مَوْعِدَكَ القادِم مَع الطَّبِيب فَوْر إِضافَتِه. لَيْسَ لَدَيْكَ مَوْعِد حَتَّى الآن، فَابْدَأ بِالضَّغْط عَلَى \'Add\' لِإِضافَة أَوَّل مَوْعِد.',
        },
      },
      speechLanguage: 'ar-EG',
      avatarState: 'pointLeft',
    ...
    // 7 ── Family Overview (state-aware)
    {
      ...
      variants: {
        populated: {
          ...
          speech: 'هُنا تَجِد بِطاقَة لِكُل فَرْد فِي عائِلَتِكَ، تَتَضَمَّن النَّوْع والعُمْر. اِضْغَط عَلَى \'AI Health Summary\' لِأَي مِنْهُم لِلحُصُول عَلَى مُلَخَّص صِحِّي فَوْرِيّ.',
        },
        empty: {
          anchor: 'add-family-member-button',
          speech: 'هُنا قِسْم \'نَظْرَة عائِلِيَّة\'، وحالِيًّا يَضُمّ مَلَفَّكَ فَقَط. اِضْغَط عَلَى \'Add Family Member\' لِإِضافَة أَحَد أَفْراد أُسْرَتِكَ ومُتابَعَة حالَتِهِ الصِّحِّيَّة أَيْضًا.',
        },
      },
      speechLanguage: 'ar-EG',
      avatarState: 'celebrate',
    ...
    },
    {
      ...
      speech: 'ومُسْتَنَدات أُخْرَى. اِسْتَخْدِم \'Scan with AI\' لِأَقُوم بِقِراءَة المُسْتَنَد واسْتِخْراج المَعْلُومات آلِيًّا، أَو \'Add Manually\' لِإِدْخالِها بِنَفْسِك.',
      speechLanguage: 'ar-EG',
      avatarState: 'wave',
      highlight: true,
      delayAfterMs: 300,
    },
    {
      ...
      speech: 'وفِي أَي وَقْت، اِضْغَط عَلَى \'Add Record\' لِتَخْتار نَوْع المُسْتَنَد وتَرْفَعَه مُباشَرَةً مِن هُنا.',
      speechLanguage: 'ar-EG',
      avatarState: 'pointLeft',
      highlight: true,
    },
    ...
    // 9 ── Appointments
    {
      ...
      route: '/appointments',
      speech: 'فِي صَفْحَة \'المَواعِيد\'، اِضْغَط عَلَى \'Add Appointment\' لِفَتْح نافِذَة تَخْتار مِنْها نَوْع المَوْعِد: زِيارَة طَبِيب، تَحْلِيل، أَشِعَّة، تَطْعِيم، كَشْف أَسْنان، جَلْسَة عِلاج، أَو مَوْعِد آخَر. بَعْد الاِخْتِيار، سَتُحَدِّد التَّارِيخ والوَقْت والتَّذْكِير.',
      speechLanguage: 'ar-EG',
      avatarState: 'pointLeft',
      highlight: true,
    },
    ...
    // 10 ── Medications (state-aware)
    {
      ...
      variants: {
        populated: {
          ...
          speech: 'هُنا تَجِد \'Next Dose\'، ويُوَضِّح اِسْم الدَّواء، الجُرْعَة، ومَوْعِد الجُرْعَة القادِمَة. اِضْغَط عَلَى \'I Took It\' فَوْر أَخْذ الدَّواء لِأُسَجِّل ذَلِكَ، وسَأُرْسِل لَكَ تَنْبِيهًا إِن تَأَخَّرْتَ.',
        },
        empty: {
          anchor: 'add-medication',
          speech: 'فِي صَفْحَة \'الأَدْوِيَة والتَّذْكِيرات\'، اِضْغَط عَلَى \'Add Medication\' لِتَسْجِيل أَوَّل دَواء. حَدِّد اِسْمَه ومَواعِيد الجُرَعات، وسَأَتَوَلَّى تَذْكِيرَكَ بِها فِي مَوْعِدِها بِالضَّبْط.',
        },
      },
      speechLanguage: 'ar-EG',
      avatarState: 'wave',
    ...
    // 11 ── Family Profiles
    {
      ...
      speech: 'فِي صَفْحَة \'Family Profiles\'، اِخْتَر أَي فَرْد لِتَجِد تَبْوِيبات: نَظْرَة عامَّة، سِجِلَّات طِبِّيَّة، مَواعِيد، أَدْوِيَة، تَذْكِيرات، ومُلَخَّص صِحِّي. كُل مَعْلُومَة عَن صِحَّتِه فِي مَكان واحِد.',
      speechLanguage: 'ar-EG',
      avatarState: 'celebrate',
      highlight: true,
    },
