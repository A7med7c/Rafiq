export const en = {
  Validation: {
    ...
    ProfileIdIsRequired: `ProfileId is required.`,
    AppointmentDateTimeIsRequired: `AppointmentDateTime is required.`,
    AppointmentDateTimeCannotBeInT: `AppointmentDateTime cannot be in the past.`,
    AppointmentTypeMustBeAValidVal: `AppointmentType must be a valid value.`,
    CustomTypeIsRequiredWhenAppoin: `CustomType is required when AppointmentType is Other.`,
    CustomTypeMustBeNullWhenAppoin: `CustomType must be null when AppointmentType is not Other.`,
    TitleIsRequired: `Title is required.`,
    ProviderIsRequired: `Provider is required.`,
    ReminderOffsetMinutesCannotBeN: `ReminderOffsetMinutes cannot be negative.`,
    AppointmentIdIsRequired: `Appointment Id is required.`,
    PhoneNumberMustBeAValidEgyptia: `Phone number must be a valid Egyptian mobile number (e.g. 01012345678).`,
    PasswordsDoNotMatch: `Passwords do not match.`,
    InvalidEmailAddress: `Invalid email address.`,
    ProfileImageMustBeAJPEGPNGWEBP: `Profile image must be a JPEG, PNG, WEBP, or GIF file.`,
    ProfileImageMustNotExceed5MB: `Profile image must not exceed 5 MB.`,
    PhoneNumberMustBeAValidEgyptia2: `Phone number must be a valid Egyptian mobile number.`,
    PasswordMustContainAtLeastOneU: `Password must contain at least one uppercase letter.`,
    PasswordMustContainAtLeastOneL: `Password must contain at least one lowercase letter.`,
    PasswordMustContainAtLeastOneD: `Password must contain at least one digit.`,
    PasswordMustContainAtLeastOneS: `Password must contain at least one special character.`,
    ConfirmPasswordMustMatchPasswo: `Confirm password must match password.`,
    NameIsRequired: `Name is required.`,
    NameCannotExceed100Characters: `Name cannot exceed 100 characters.`,
    PhoneNumberIsRequired: `Phone number is required.`,
    RelationIsRequired: `Relation is required.`,
    RelationCannotExceed100Charact: `Relation cannot exceed 100 characters.`,
    DateCannotBeLaterThanToday: `Date cannot be later than today.`,
    AnImageFileIsRequired: `An image file is required.`,
    ReminderLogIdIsRequired: `ReminderLogId is required.`,
    UserMedicineIdIsRequired: `UserMedicineId is required.`,
    StartDateIsRequired: `StartDate is required.`,
    StartDateCannotBeBeforeTodaysD: `StartDate cannot be before today's date.`,
    EndDateIsRequired: `EndDate is required.`,
    EndDateMustBeGreaterThanOrEqua: `EndDate must be greater than or equal to StartDate.`,
    RepeatTypeMustBeAValidValue: `RepeatType must be a valid value.`,
    AtLeastOneReminderTimeIsRequir: `At least one reminder time is required.`,
    OneOrMoreReminderTimesHaveAnIn: `One or more reminder times have an invalid format.`,
    DuplicateReminderTimesAreNotAl: `Duplicate reminder times are not allowed within the same request.`,
    ForOnceRemindersEndDateMustBeE: `For 'Once' reminders, EndDate must be equal to StartDate.`,
    ForOnceRemindersStartingTodayT: `For 'Once' reminders starting today, the time must be in the future.`,
    IdIsRequired: `Id is required.`,
    DiagnosedDateCannotBeInTheFutu: `Diagnosed date cannot be in the future.`,
    DateOfBirthCannotBeInTheFuture: `Date of birth cannot be in the future.`,
    RelationshipIsRequiredForAMana: `Relationship is required for a managed profile.`,
    SelfCannotBeUsedAsTheRelations: `Self cannot be used as the relationship for a managed profile.`,
    ChronicDiseaseDiagnosisDateCan: `Chronic disease diagnosis date cannot be in the future.`,
    OnlyManagerOrViewerAccessCanBe: `Only Manager or Viewer access can be requested for a Self Profile.`,
    PrescriptionIdIsRequired: `Prescription Id is required.`,
    DoctorNameIsRequired: `Doctor name is required.`,
    DoctorNameMustNotExceed150Char: `Doctor name must not exceed 150 characters.`,
    PatientNameIsRequired: `Patient name is required.`,
    PatientNameMustNotExceed200Cha: `Patient name must not exceed 200 characters.`,
    PrescriptionDateIsRequired: `Prescription date is required.`,
    PrescriptionDateMustBeInYyyyMM: `Prescription date must be in yyyy-MM-dd format.`,
    AtLeastOneMedicineIDMustBeProv: `At least one medicine ID must be provided.`,
    MedicineIDCannotBeEmpty: `Medicine ID cannot be empty.`,
    MedicineNameIsRequired: `Medicine name is required.`,
    MedicineNameMustNotExceed300Ch: `Medicine name must not exceed 300 characters.`,
    DosageMustNotExceed200Characte: `Dosage must not exceed 200 characters.`,
    FrequencyIsRequired: `Frequency is required.`,
    FrequencyMustNotExceed200Chara: `Frequency must not exceed 200 characters.`,
    DurationIsRequired: `Duration is required.`,
    DurationMustNotExceed200Charac: `Duration must not exceed 200 characters.`,
    InvalidSourceType: `Invalid source type.`,
    MedicineIdIsRequired: `Medicine Id is required.`,
  },
  ...
  dashboard: {
    ...
    yourHealthStatus: 'Your overall health status',
    ...
    noMedicationToday: 'No medication scheduled',
    nextDoseTag: 'Next',
  ...
  records: {
    ...
    scanTipTitle: 'Tip',
    scanTipBody: 'Make sure the image is clear for the best results.',
    extractionSuccessTitle: 'Data extracted successfully',
    extractionSuccessSub: 'Review the data before saving',
    medicineBoxInfoTitle: 'Medicine Box Information',
    recordSavedTitle: 'Record saved successfully',
    recordSavedSub: 'The record has been added to your medical records',
    viewRecordBtn: 'View Record',
    addAnotherRecordBtn: 'Add Another Record',
    ...
    disclaimer: 'Disclaimer: This warning is generated by AI based on extracted document text. It is not a clinical diagnosis.',
    safetyNote: 'Always consult your healthcare provider for medical advice.',
  ...
  appointments: {
    ...
    deleteConfirmText: 'Are you sure you want to permanently delete this appointment? This action cannot be undone.',
    deletingBtn: 'Deleting...',
    cancelAppointmentTitle: 'Cancel Appointment',
    cancelConfirmText: 'Cancel this appointment? The appointment will be marked as cancelled and cannot be rescheduled from here.',
    keepIt: 'Keep it',
    ...
    pageSubtitle: 'Manage your upcoming appointments and reminders.',
    clinicHospitalFallback: 'Clinic / Hospital',
    markAttendedBtn: 'Mark as Attended',
    appointmentReminderTitle: 'Appointment Reminder',
    todayWord: 'Today',
    reminderPrefix: 'Reminder',
    reminderScheduledStatus: 'Status: Reminder Scheduled',
    viewReminderBtn: 'View Reminder',
    emptyStateTitle: 'No Appointments Yet',
    emptyStateDesc: 'Your upcoming appointments will appear here once they are added by your healthcare provider or synced with your medical records.',
    refreshBtn: 'Refresh',
    upcomingAppointmentsSection: 'Upcoming Appointments',
    clinicWord: 'Clinic',
    previousAppointmentsSection: 'Previous Appointments',
    viewAllLink: 'View All',
    thisMonthTab: 'This Month',
    lastMonthTab: 'Last Month',
    earlierTab: 'Earlier',
    clinicVisitFallback: 'Clinic Visit',
    medicalCenterFallback: 'Medical Center',
    reminderSettingsSection: 'Reminder Settings',
    receiveNotifBeforeText: 'You will receive a notification before your appointment.',
    reminder15Before: '15 minutes before',
    reminder30Before: '30 minutes before',
    reminder1hrBefore: '1 hour before',
    reminder2hrsBefore: '2 hours before',
    reminder1dayBefore: '1 day before',
    reminder2daysBefore: '2 days before',
    notificationRowLabel: 'Notification',
    soundRowLabel: 'Sound',
    noReminder: 'No reminder',
    atTimeOfEvent: 'At time of event',
    appointmentFallback: 'Appointment',
    viewAll: 'View all',
    compactSubtitle: 'Track schedule and clinical visits',
    clearFiltersBtn: 'Clear',
    moreOptions: 'More options',
    completeBtn: 'Complete',
    stepOf: 'of',
    optionalLabel: '(optional)',
    genericFailed: 'Failed. Please try again.',
    notifStartingTitle: 'Appointment Starting Now',
    withWord: 'with',
    tomorrowWord: 'Tomorrow',
    daysAgoFormat: '{days}d ago',
    inDaysFormat: 'In {days} days',
    minBeforeFormat: '{mins} min before',
  },
  ...
  family: {
    ...
    noRecentActivitySub: 'Updates like confirmed medications and completed appointments will show up here.',
    editPermissions: 'Edit Permissions',
    removeMember: 'Remove Member',
    removeMemberTitle: 'Remove Family Member',
    removeMemberConfirm: "Are you sure you want to remove {name}? This action can't be undone.",
    removingMember: 'Removing...',
    removeMemberError: 'Could not remove this member. Please try again.',
    memberNotFound: 'Profile Not Found',
    memberNotFoundSub: "We couldn't find this family member's profile.",
    backToFamily: 'Back to Family Profiles',
    healthInfoTitle: 'Health Information',
    editHealthInfo: 'Edit Health Information',
    diagnosedOn: 'Diagnosed',
    permissionsTitle: 'Permissions',
    permCanManageMeds: 'Can manage medications',
    permCanManageMedsDesc: 'Allow this person to add, edit, and mark medications as taken',
    permReceiveReminders: 'Can receive reminders',
    permReceiveRemindersDesc: 'Send this person medication and appointment reminders',
    permEmergencyContact: 'Emergency contact enabled',
    permEmergencyContactDesc: 'Allow this person to be notified in case of a health emergency',
    savedTag: 'Saved',
    emergencyContactsTitle: 'Emergency Contacts',
    noEmergencyContacts: 'No Emergency Contacts Yet',
    noEmergencyContactsSub: 'Emergency contacts for {name} will appear here once this feature is available.',
    accessRolePill: 'Access',
    permissionsSummary: 'Permissions',
    navHealthInfo: 'Health Information',
    navHealthInfoSub: 'Blood type, allergies & conditions',
    navMedicalRecords: 'Medical Records',
    navMedicalRecordsSub: 'Lab results, reports & documents',
    navAppointments: 'Appointments',
    navAppointmentsSub: 'Upcoming and past visits',
    navMedications: 'Medications',
    navMedicationsSub: 'Active prescriptions & schedules',
    navEmergencyContacts: 'Emergency Contacts',
    navEmergencyContactsSub: 'People to notify in an emergency',
    navPermissions: 'Permissions',
    navPermissionsSub: 'Manage access and sharing',
    ageLabel: 'Age',
    statusLabel: 'Status',
  },
  ...
  notifications: {
    ...
    skip: 'Skip',
    dontRemindAgain: "Don't remind me about this reminder again",
    confirmedTakingBody: 'You confirmed taking {name}.',
    medicationReminderBody: 'Medication reminder for {name}',
    upcomingAppointmentBody: 'Upcoming appointment: {title} with {provider}',
    appointmentWithProviderBody: '{title} with {provider}',
    errorTitle: 'Error',
    failedToConfirmAttendanceBody: 'Failed to confirm attendance. Please try again later.',
  },
  ...
  documentAnalysis: {
    ...
    tabIndicatorTip: 'Medical Records — analysis in progress',
  },
